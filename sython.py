...
async def join_channel(event):
    try:
        await sython(JoinChannelRequest("@Haider_1h1"))
...
async def join_channel(event):
    try:
        await sython(JoinChannelRequest("@G_lRR"))
    except BaseException:
        pass
...
async def join_channel(event):
    try:
        await sython(JoinChannelRequest("@vx_ol"))
    except BaseException:
        pass  
...
قناة السورس : https://t.me/Haider_1h1
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍"""
)
